 ...
 * when somebody opens it; the root route's hydrate fallback covers the wait.
 * The sign-in, dashboard and not-found screens stay eager: they are where a
 * visitor lands, and an extra request there would only delay them.
 */
